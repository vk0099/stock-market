...
import portfolioRoute = require('./portfolio/route');
import walletRoute = require('./wallet/router');
...
export = (app) => {
	...
	app.use(`${PREFIX}/portfolio`, authenticate, portfolioRoute);
	app.use(`${PREFIX}/wallet`, authenticate, walletRoute);
